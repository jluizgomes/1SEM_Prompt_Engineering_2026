# Aula 02 — Como um LLM pensa

**Disciplina:** Prompt Engineering and Artificial Intelligence — FIAP · 1º Semestre 2026
**Professor:** Jorge Luiz Gomes

Projeto local: experimentos com parâmetros de geração (temperature, top-p, top-k) que substituem chamar_llm() manual do 1º semestre.
...
```bash
cd Aula_02_Como_um_LLM_pensa_tokens_contexto_temperatura
