# Aula 05 — Zero shot, One shot, Few shot

**Disciplina:** Prompt Engineering and Artificial Intelligence — FIAP · 1º Semestre 2026
**Professor:** Jorge Luiz Gomes

Projeto local: experimentos com diferentes estratégos de few-shot prompting que substituem chamar_llm() manual do 1º semestre.
...
```bash
cd Aula_05_Zero_shot_One_shot_Few_shot
