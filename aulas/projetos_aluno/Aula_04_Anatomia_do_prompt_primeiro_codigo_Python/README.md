# Aula 04 — Anatomia do prompt

**Disciplina:** Prompt Engineering and Artificial Intelligence — FIAP · 1º Semestre 2026
**Professor:** Jorge Luiz Gomes

Projeto local: primeiros exemplos de Python com chamadas a LLMs que substituem chamar_llm() manual do 1º semestre.
...
```bash
cd Aula_04_Anatomia_do_prompt_primeiro_codigo_Python
