# Aula 09 — Histórico de conversa

**Disciplina:** Prompt Engineering and Artificial Intelligence — FIAP · 1º Semestre 2026
**Professor:** Jorge Luiz Gomes

Projeto local: experimentos com histórico de conversa que substituem chamar_llm() manual do 1º semestre.
...
```bash
cd Aula_09_Historico_de_conversa_como_chatbot_lembra
