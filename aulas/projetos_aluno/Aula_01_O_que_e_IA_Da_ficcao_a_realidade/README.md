...
Projeto local: exemplos básicos de IA com Ollama LangChain — substitui chamar_llm() manual do conhecimento prévio.
...
```bash
cd Aula_01_O_que_e_IA_Da_ficcao_a_realidade
