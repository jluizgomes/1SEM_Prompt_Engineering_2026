...
Aula 07 — Role prompting: parâmetros do modelo

Projeto local: experimentos com role prompting que substituem o
...
def demo_role() -> None:
    """Demo de role prompting com diferentes personas."""
    # TODO: Use chain_texto.invoke() com 3 roles diferentes e compare
    # TODO: Imprima as respostas e note como a persona afeta o estilo
    pass


def main() -> None:
    print(f"Ollama Cloud | modelo: {OLLAMA_MODEL}\n")
    # TODO: Chamar demo_role()
