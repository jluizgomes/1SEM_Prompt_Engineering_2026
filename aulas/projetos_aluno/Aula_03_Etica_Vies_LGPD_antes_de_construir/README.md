# Aula 03 — Ética, VIés, LGPD

**Disciplina:** Prompt Engineering and Artificial Intelligence — FIAP · 1º Semestre 2026
**Professor:** Jorge Luiz Gomes

Projeto local: demonstração de princípios éticos, detecção de viés e conformidade LGPD que substituem chamar_llm() manual do 1º semestre.
...
```bash
cd Aula_03_Etica_Vies_LGPD_antes_de_construir
