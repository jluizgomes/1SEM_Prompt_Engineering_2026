...
def demo_templates() -> None:
    ...
    # Variáveis diferentes para o mesmo template
    variaveis = [
        {"persona": "um chef de culinária", "especialidade": "culinária", "pergunta": "Como assar um bolo?"},
        {"persona": "um programador", "especialidade": "Python", "pergunta": "Como definir uma função?"},
        {"persona": "um designer", "especialidade": "Figma", "pergunta": "Como criar um componente?"},
    ]
    for i, vars in enumerate(variaveis, 1):
        resposta = chain.invoke(vars)
        print(f"=== Template {i} ===")
        print(resposta)
        print()
